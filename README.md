...
● severity is high
The system should prioritise reliable decision support over fully automated model updates.
—----------
To be updated in the README roadmap section from:
```markdown
* BIM / Revit linking
* IFC object tagging
* JSON defect schema
...
To
* structured JSON/CSV defect records
* BIM / Revit element association
* IFC GUID tagging
* Digital Twin condition state model
* evidence-linked inspection records
* façade condition dashboard
* condition trend analytics and maintenance prioritisation
—-----------
To be added under Included in this repository:
Digital Twin integration strategy documented in `docs/digital_twin_integration.md`
